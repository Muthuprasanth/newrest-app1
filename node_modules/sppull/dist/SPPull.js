...
var Download = (function () {
    function Download() {
        ...
        this.runCreateFoldersRecursively = function () {
            return new Promise(function (resolve, reject) {
                return _this.getStructureRecursive()
                    .then(function (data) {
                    if ((data.folders || []).length > 0) {
                        resolve(_this.createFoldersQueue(data.folders, 0));
                    }
                    else {
                        resolve([]);
                    }
        ...
        this.downloadMyFilesHandler = function (data) {
            return new Promise(function (resolve, reject) {
                if ((data.files || []).length > 0) {
                    resolve(_this.downloadFilesQueue(data.files, 0));
                }
                else {
                    resolve([]);
                }
        ...
        this.runDownloadStrictObjects = function () {
            return new Promise(function (resolve, reject) {
                var filesList = _this.options.strictObjects.filter(function (d) {
                    var pathArr = d.split('/');
                ...
                if (filesList.length > 0) {
                    resolve(_this.downloadFilesQueue(filesList, 0));
                }
                else {
                    resolve([]);
                }
